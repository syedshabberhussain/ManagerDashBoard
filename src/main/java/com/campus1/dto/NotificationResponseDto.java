...
public class NotificationResponseDto {
		...
		public NotificationResponseDto(Long id, String subject, String message, String sentBy, LocalDateTime sentAt,
		...
		public String toString() {
			return "NotificationResponseDto [id=" + id + ", subject=" + subject + ", message=" + message + ", sentBy="
